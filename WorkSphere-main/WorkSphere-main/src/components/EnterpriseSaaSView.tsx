          ...
          return (
            <button
              ...
              className={`px-4 py-2.5 rounded-xl text-xs font-bold flex items-center space-x-2.5 transition-all whitespace-nowrap border ${
                active
                  ? "bg-orange-600 text-white border-orange-600 shadow-md shadow-orange-600/10 scale-[1.02]"
                  : isDarkMode
      ...
      <div className={`lg:col-span-7 p-6 rounded-2xl border ${
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs font-bold">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-orange-600 hover:bg-orange-700 text-white rounded-xl font-bold uppercase tracking-wider flex items-center justify-center space-x-2"
          >
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div className={`lg:col-span-8 p-6 rounded-2xl border ${
        ...
        <form onSubmit={handleSaveWorkflow} className="space-y-4 text-xs font-bold">
          ...
          <button
            type="submit"
            className="w-full py-2.5 bg-orange-600 hover:bg-orange-700 text-white rounded-xl uppercase tracking-wider font-extrabold text-[11px] mt-4"
          >
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 text-xs">
      ...
      <div className={`lg:col-span-5 p-6 rounded-2xl border ${
        ...
        <form onSubmit={handleCreateStep} className="space-y-4 font-bold">
          ...
          <button
            type="submit"
            className="w-full py-2.5 bg-orange-600 hover:bg-orange-700 text-white rounded-xl uppercase font-black"
          >
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div className={`md:col-span-5 p-5 rounded-2xl border ${
                  ...
                  <form onSubmit={handleProcure} className="space-y-3 font-bold">
                    ...
                    <button type="submit" className="w-full py-2.5 bg-orange-600 text-white font-extrabold rounded-xl uppercase">
                      Queue PO Request
                    </button>
                  </form>
                </div>
                    ...
                    {realCameraScan ? (
                      ...
                      scanning ? (
                        ...
                        <button
                          ...
                          className="px-4 py-2.5 bg-orange-600 hover:bg-orange-700 text-white rounded-xl font-bold uppercase tracking-wider text-[10px]"
                        >
                    ...
                    <form onSubmit={handleSaasQuickUpdateSubmit} className="space-y-3 p-3 bg-orange-500/5 rounded-xl border border-orange-500/10 font-semibold text-[11px] text-left">
                      ...
                      <div className="flex gap-2 pt-1">
                        ...
                        <button
                          ...
                          className="flex-1 py-2 bg-orange-600 hover:bg-orange-700 text-white font-bold rounded-lg text-[10px] uppercase flex items-center justify-center space-x-1"
                        >
      ...
      <div className={`lg:col-span-5 p-5 rounded-2xl border ${
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-2.5 py-1.5 bg-orange-600 text-white rounded-lg font-bold uppercase tracking-wider text-[10px] flex items-center space-x-1"
          >
            <Plus className="h-3 w-3" />
            ...
            <div className="space-y-3 pt-2">
              ...
              <form onSubmit={handleComment} className="flex gap-2">
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl border dark:bg-stone-950 dark:border-stone-900"
                />
                <button type="submit" className="p-2.5 bg-orange-600 hover:bg-orange-700 text-white rounded-xl">
      ...
      <div className={`lg:col-span-6 p-5 rounded-2xl border ${
        ...
        <div className="space-y-3 font-bold">
          <button
            ...
            disabled={checking}
            className="w-full py-2.5 bg-orange-600 hover:bg-orange-700 text-white rounded-xl uppercase font-extrabold tracking-wider"
          >
            Run Location Audit
          </button>
              ...
              {an.status === "pending_review" && (
                <div className="flex space-x-2 pt-1">
                  ...
                  <button
                    ...
                    className="px-2 py-1 bg-orange-600 text-white rounded text-[9px] font-bold"
                  >
                    Excuse Violations
                  </button>
                </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 text-xs">
      ...
      <div className={`lg:col-span-4 p-5 rounded-2xl border ${
        ...
        <form onSubmit={handleCreateDoc} className="space-y-3 font-bold">
          ...
          <button type="submit" className="w-full py-2.5 bg-orange-600 hover:bg-orange-700 text-white font-extrabold rounded-xl uppercase">
            Upload & Encrypt File
          </button>
        </form>
      </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2 font-bold text-[10px]">
                  ...
                  <button
                    ...
                    className="w-1/2 py-2 bg-orange-600 text-white rounded-lg uppercase"
                  >
                    Lock Signature
                  </button>
                </div>
