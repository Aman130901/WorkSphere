      ...
      <div className="p-5 rounded-xl border bg-white dark:bg-stone-900 border-stone-200 dark:border-stone-800 shadow-sm flex flex-col sm:flex-row items-center sm:items-start gap-5">
        <div className="relative shrink-0">
          {currentUser.avatarUrl ? (
            ...
            <div className="h-20 w-20 rounded-full bg-orange-600 text-white flex items-center justify-center text-xl font-extrabold border border-stone-200 dark:border-stone-800">
          ...
          <button
            ...
            className="absolute -bottom-1 -right-1 h-7 w-7 rounded-full bg-orange-600 hover:bg-orange-700 text-white flex items-center justify-center shadow-md border-2 border-white dark:border-stone-900 disabled:opacity-60"
          >
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
              <button
                ...
                onClick={handleAvatarPick}
                disabled={avatarSaving}
                className="px-3 py-2 text-xs font-bold rounded-lg bg-orange-600 hover:bg-orange-700 text-white flex items-center space-x-1.5 disabled:opacity-60"
              >
              ...
              return (
                <button
                  ...
                  className={`w-full p-2.5 rounded-lg flex items-center space-x-2.5 text-left font-bold transition-all ${
                    isActive
                      ? "bg-orange-600 text-white shadow shadow-orange-500/15"
            ...
            {adminActiveTab === "attendance" && (
              <form onSubmit={handleSaveSettings} className="p-5 rounded-xl border bg-white dark:bg-stone-900 border-stone-200 dark:border-stone-800 shadow-sm space-y-5 text-xs font-semibold">
                      ...
                      return (
                        <button
                          ...
                          className={`p-2 px-3.5 rounded-lg border font-bold transition-all ${
                            active
                              ? "bg-orange-600 border-orange-600 text-white shadow shadow-orange-500/15"
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full py-3 bg-orange-600 hover:bg-orange-700 disabled:opacity-50 text-white rounded-xl font-bold uppercase tracking-wider flex items-center justify-center space-x-1.5"
                >
                ...
                <div className="p-5 rounded-xl border bg-white dark:bg-stone-900 border-stone-200 dark:border-stone-800 shadow-sm text-xs font-semibold space-y-4">
                  ...
                  <div className="flex pt-2">
                    <button
                      ...
                      className="w-full py-2.5 bg-orange-600 hover:bg-orange-700 disabled:opacity-60 text-white rounded-lg font-bold flex items-center justify-center space-x-2"
                    >
          ...
          <div className="p-4 rounded-xl border bg-white dark:bg-stone-900 border-stone-200 dark:border-stone-800 shadow-sm space-y-2 text-xs">
            ...
            <div className="flex items-center space-x-3 p-2 pb-4 mb-2 border-b border-stone-100 dark:border-stone-800">
              {currentUser.avatarUrl ? (
                ...
                <div className="h-10 w-10 rounded-full bg-orange-600 text-white flex items-center justify-center text-xs font-extrabold border border-stone-200 dark:border-stone-800">
                  {(currentUser.firstName?.[0] || "").toUpperCase()}{(currentUser.lastName?.[0] || "").toUpperCase()}
                </div>
              )}
            ...
            {essTab === "resume" && (
              <form onSubmit={handleSaveProfile} className="p-5 rounded-xl border bg-white dark:bg-stone-900 border-stone-200 dark:border-stone-800 shadow-sm space-y-5 text-xs font-semibold">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full py-3 bg-orange-600 hover:bg-orange-700 disabled:opacity-50 text-white rounded-xl font-bold uppercase tracking-wider flex items-center justify-center space-x-1.5 shadow-sm shadow-orange-500/20"
                >
                  {submitting ? <Loader2 className="h-4 w-4 animate-spin" /> : <Save className="h-4 w-4" />}
