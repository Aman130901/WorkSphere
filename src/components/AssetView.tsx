                        ...
                        <td className="p-4 space-x-1">
                          {ast.status === "Available" ? (
                            <button
                              ...
                              className="px-2 py-1 text-[10px] font-bold text-white bg-gradient-to-br from-[#ea503f] to-[#7a1505] hover:from-red-500 hover:to-red-700 border border-white/10 rounded-md shadow uppercase tracking-wide"
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <h3 className="text-xl font-extrabold mb-1" style={{ fontFamily: "'Outfit', sans-serif" }}>Log IT Hardware Asset</h3>
            <p className="text-[11px] text-white/50 mb-6 font-medium">Add a workstation, accessory, or software subscription into active inventory.</p>
            ...
            <form onSubmit={handleAddSubmit} className="space-y-5 text-xs font-semibold">
              <div>
                <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">Asset Display Name *</label>
                <input
                  required
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">Category *</label>
                  <select
                ...
                <div>
                  <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">Book Value ($ USD) *</label>
                  <input
                    required
                    type="number"
              ...
              <div>
                <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">Serial Number (S/N) *</label>
                <input
                  required
                  value={addFields.serialNumber}
                  onChange={e => setAddFields({ ...addFields, serialNumber: e.target.value })}
                  placeholder="e.g. C02F87X8Q05D"
                  className="w-full p-3 rounded-xl border border-white/10 bg-black/40 text-white text-sm outline-none transition-all hover:border-white/20 focus:border-red-500 shadow-inner placeholder-white/20 font-mono"
                />
              </div>
              ...
              >
                ...
                <span className="drop-shadow">REGISTER HARDWARE INTO STOCK</span>
              </button>
            </form>
          </motion.div>
        </div>
          ...
          >
            ...
            <form onSubmit={handleAssignSubmit} className="space-y-4 text-xs font-semibold">
              ...
              <button
                ...
                className="w-full py-3.5 bg-gradient-to-br from-[#ea503f] to-[#7a1505] hover:from-red-500 hover:to-red-700 border border-white/10 text-white rounded-xl font-bold uppercase tracking-wider flex items-center justify-center space-x-1.5 disabled:opacity-50 text-xs"
      ...
      {showScanModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            className="w-full max-w-lg p-6 rounded-3xl border shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative z-50 bg-[#0a0a0a]/90 backdrop-blur-3xl text-white border-white/20"
          >
            <button
              onClick={() => {
                setShowScanModal(false);
            ...
            <div className="flex items-center space-x-2.5 mb-2">
              ...
              <div>
                <h3 className="text-xl font-extrabold mb-1" style={{ fontFamily: "'Outfit', sans-serif" }}>Asset QR Scanner</h3>
                <p className="text-[11px] text-white/50">Scan physical barcode tags using your camera to modify custody, status, or location.</p>
              </div>
            </div>
            ...
            {!scannedAsset && (
              <div className="space-y-4">
                  ...
                  {scanError && (
                    <div className="absolute inset-0 bg-stone-900/90 flex flex-col items-center justify-center p-6 text-center space-y-3">
                      ...
                      <button
                        ...
                        className="p-2 px-4 bg-gradient-to-br from-[#ea503f] to-[#7a1505] hover:from-red-500 hover:to-red-700 text-white rounded-xl font-extrabold uppercase tracking-widest text-[10px] shadow-lg shadow-red-600/30 transition-all border border-white/10"
                      >
                        <span className="drop-shadow">RETRY SCAN</span>
                      </button>
                    </div>
                  )}
                </div>
                ...
                <div className="p-4 bg-white/5 rounded-2xl border border-white/10 space-y-3">
                  <span className="text-[10px] uppercase font-black tracking-wider text-white/60 block">Manual Lookup Override</span>
                  <div className="flex gap-2">
                    <input
                      type="text"
                      placeholder="Enter Asset ID or Serial Number..."
                      className="flex-1 p-3 rounded-xl border border-white/10 bg-black/40 text-white text-xs outline-none transition-all hover:border-white/20 focus:border-red-500 shadow-inner font-mono placeholder-white/20"
                      onKeyDown={(e) => {
                        if (e.key === 'Enter') {
                    ...
                    <button
                      ...
                      className="px-5 bg-white/10 hover:bg-white/20 text-white font-bold rounded-xl text-[10px] uppercase tracking-widest transition-colors border border-white/10"
                    >
                      Locate
                    </button>
                  </div>
              ...
              <form onSubmit={handleScanUpdateSubmit} className="space-y-4 font-semibold text-xs">
                ...
                <div className="flex space-x-2 pt-2">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="flex-1 py-3 bg-gradient-to-br from-[#ea503f] to-[#7a1505] hover:from-red-500 hover:to-red-700 border border-white/10 text-white font-bold rounded-xl uppercase tracking-wider flex items-center justify-center space-x-1 disabled:opacity-50 text-xs"
                  >
