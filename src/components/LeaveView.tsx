                ...
                return (
                  <div
                    ...
                    className={`p-1.5 py-2.5 rounded-lg border border-transparent font-semibold relative group ${
                      absenceInfo
                        ? "bg-gradient-to-br from-[#ea503f] to-[#7a1505] hover:from-red-500 hover:to-red-700 text-white border border-white/10 shadow-md shadow-red-600/20 shadow shadow-red-600/30"
                        : isDarkMode
