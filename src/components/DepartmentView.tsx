      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <h3 className="text-xl font-extrabold mb-1" style={{ fontFamily: "'Outfit', sans-serif" }}>Onboard Subdivision Department</h3>
            <p className="text-[11px] text-white/50 mb-6 font-medium">Create a functional cluster with structural code parameters and leading staff.</p>
            ...
            <form onSubmit={handleAddSubmit} className="space-y-5 text-xs font-semibold">
              <div>
                <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">Subdivision Name *</label>
                <input
                  required
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">Structural Code *</label>
                  <input
                    required
                ...
                <div>
                  <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">Annual Budget Estimate ($) *</label>
                  <input
                    required
                    type="number"
              ...
              <div>
                <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">Select Department Lead (Manager)</label>
                <select
              ...
              >
                ...
                <span className="drop-shadow">REGISTER DEPARTMENT</span>
              </button>
            </form>
          </motion.div>
        </div>
