      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        {currentUser.role === "admin" && (
          <button
            ...
            className="p-3 px-5 bg-gradient-to-br from-[#ea503f] to-[#7a1505] hover:from-red-500 hover:to-red-700 border border-white/10 text-white rounded-xl shadow-lg shadow-red-600/30 text-xs font-bold uppercase tracking-wider flex items-center space-x-1.5 self-stretch sm:self-auto justify-center"
                      ...
                      >
                        <td className="p-4 flex items-center space-x-3">
                          {emp.avatarUrl ? (
                            ...
                            <div className="h-8 w-8 rounded-full bg-gradient-to-br from-[#ea503f] to-[#7a1505] hover:from-red-500 hover:to-red-700 text-white border border-white/10 shadow-md shadow-red-600/20 flex items-center justify-center text-[10px] font-extrabold flex-shrink-0 border border-stone-200 dark:border-stone-800">
              ...
              <div className="space-y-6 text-xs text-stone-700 dark:text-stone-300">
                ...
                <div className="text-center relative">
                  {inspectedEmployee.profile.avatarUrl ? (
                    ...
                    <div className="h-16 w-16 rounded-full bg-gradient-to-br from-[#ea503f] to-[#7a1505] hover:from-red-500 hover:to-red-700 text-white border border-white/10 shadow-md shadow-red-600/20 flex items-center justify-center text-lg font-extrabold mx-auto border-2 border-orange-500">
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <motion.div
            ...
            className="w-full max-w-lg p-6 rounded-3xl border shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative z-50 bg-[#0a0a0a]/90 backdrop-blur-3xl text-white border-white/20 my-8"
          >
            <button
            ...
            <h3 className="text-xl font-extrabold mb-1" style={{ fontFamily: "'Outfit', sans-serif" }}>Onboard & Create Employee Account</h3>
            <p className="text-[11px] text-white/50 mb-6 font-medium">Complete the mandatory operational HR records to generate corporate portal keys.</p>
            ...
            <form onSubmit={handleAddSubmit} className="space-y-5 text-xs font-semibold">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">First Name *</label>
                  <input
                    required
                ...
                <div>
                  <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">Last Name *</label>
                  <input
                    required
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">Corporate Email *</label>
                  <input
                    required
                    type="email"
                ...
                <div>
                  <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">Portal Password *</label>
                  <input
                    required
                    type="password"
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div>
                  <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">Department</label>
                  <select
                ...
                <div>
                  <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">Job Title *</label>
                  <input
                    required
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">Personal Phone</label>
                  <input
                ...
                <div>
                  <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">Emergency contact info</label>
                  <input
              ...
              <div>
                <label className="block text-white/60 mb-1.5 font-bold text-[10px] uppercase tracking-wider">Technical Skills Register (Comma separated)</label>
                <input
              ...
              >
                ...
                <span className="drop-shadow">ONBOARD EMPLOYEE INTO DIRECTORY</span>
              </button>
            </form>
          </motion.div>
        </div>
