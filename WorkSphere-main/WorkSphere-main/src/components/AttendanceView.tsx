                ...
                <div className="grid grid-cols-2 gap-2">
                  {userTodayLog.breakStart && !userTodayLog.breakEnd ? (
                    <button
                      ...
                      className="py-3 bg-orange-600 hover:bg-orange-700 text-white rounded-xl font-bold uppercase tracking-wider text-xs flex items-center justify-center space-x-1.5 shadow-md shadow-orange-500/10"
