  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 font-sans" id="hr-copilot-container">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="w-14 h-14 bg-gradient-to-br from-[#ea503f] to-[#7a1505] hover:from-red-500 hover:to-red-700 border border-white/10 text-white rounded-full flex items-center justify-center shadow-xl shadow-red-600/30 cursor-pointer relative"
